...
eventsRouter.get('/', authenticate, cacheControl(60), asyncHandler(eventController.list));
eventsRouter.post('/', authenticate, validate(createEventSchema), asyncHandler(eventController.create));
eventsRouter.get('/:eventId', authenticate, cacheControl(60), asyncHandler(eventController.get));
